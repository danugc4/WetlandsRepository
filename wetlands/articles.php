...
<script>
        $("table").delegate('td', 'mouseover mouseleave', function(e) {             if (e.type == 'mouseover') {
...
<div class="container">
    <?php
    $resultSet = DB::getInstance()->query("SELECT * FROM Literature ORDER BY listPriority, LiteratureDate DESC");
